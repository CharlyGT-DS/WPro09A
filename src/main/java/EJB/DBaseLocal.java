...
public interface DBaseLocal { 
    public Object repuestaApi(Object clase,String tipo, String sql);
    public <T> T[] respuestaApiVector(Class<T[]> clase, String tipo, String sql);
    public <T> List<T> convierteObjetoLista(String sql, Class<T> classOfT);
