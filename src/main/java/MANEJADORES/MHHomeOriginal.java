...
//import estructuras.PefilInabOriginal;
...
//@Named("mHHome")
//@SessionScoped
//public class MHHomeOriginal implements Serializable{
//    
//    @EJB
...
//    private estructuras.PefilInabOriginal per = new PefilInabOriginal();
...
//    }
//
//    public PefilInabOriginal getPer() {
//        return per;
//    }
//
//    public void setPer(PefilInabOriginal per) {
//        this.per = per;
//    }
//        
//        @PostConstruct
...
//                Logger.getLogger(MHHomeOriginal.class.getName()).log(Level.SEVERE, null, ex);
//            }
//                
//        }
//        
//        
//        public void carga2(){
//              per = new estructuras.PefilInabOriginal();
//              
//                try{
//                    
//
...
//                  
//                           // usuario origen
//                           sql=  UTILIDADES.SQLOriginal.busquedaUsuarioPorId(1150);
...
//                           sql = UTILIDADES.SQLOriginal.llamaJuridicoPorId(1150);
...
//                             sql=  UTILIDADES.SQLOriginal.busquedaUsuarioPorId(3562);
...
//                        this.rx="";
//                   
//                    Future<estructuras.PefilInabOriginal> tpp =  fred.buscaUsuarioConectado(this.ra, this.per);
//                    this.per =  tpp.get();
//                   
//                     
//                    if(this.rx!=""){
...
//                         // this.per = tper4.get();
//                          Future<estructuras.PefilInabOriginal> tper5 =   fred.buscaLicencias(this.ra,this.per);
//                          this.per = tper5.get();
//                          
//                           Future<estructuras.PefilInabOriginal> tper6 = fred.buscaUsuario(ra, per);
//                           this.per = tper6.get();
//                           
//                          
//                           
