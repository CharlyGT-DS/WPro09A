...
public class FuncionesRedis implements Serializable, FuncionesRedisLocal{
    ...
    public Future<estructuras.PefilInab> buscaUsuarioConectado(String idUsuario,estructuras.PefilInab per){
           ...
           String sql =UTILIDADES.SQL.obtieneTcUsuarioPorId(idUsuario,"tu"); //tc_usario
            ...
            tablas.MANEJO.TcPerfil tper = (tablas.MANEJO.TcPerfil) this.api.repuestaApi(new tablas.MANEJO.TcPerfil(),"JSON",sql); 
    ...
    public Future<estructuras.PefilInab> buscaUsuario(String idUsuario,estructuras.PefilInab per){
            ...
            */
            ...
            tablas.MANEJO.TcPersona tp = (tablas.MANEJO.TcPersona) this.api.repuestaApi(new tablas.MANEJO.TcPersona(),"JSON",sql); 
            per.setTcPersona(tp);
            
            sql = UTILIDADES.SQL.obtieneTcUsuarioPorId(idUsuario,"sb");
            tablas.MANEJO.TcSubregion sb = (tablas.MANEJO.TcSubregion)  this.api.repuestaApi(new tablas.MANEJO.TcSubregion(),"JSON",sql); 
    ...
    public Future<GEnericaCincoCampos> registraDatos(String sql){          
         GEnericaCincoCampos cinco =  (GEnericaCincoCampos) this.api.repuestaApi(new GEnericaCincoCampos(),"JSON", sql);             
