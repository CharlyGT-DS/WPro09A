 ...
 * @author csandoval
 */
public class TcSubregional implements Serializable {
    ...
    private TcCultura tcCultura;
    private TcIdioma tcIdioma;
    private TcEstadoCivil tcEstadoCivil;
    private TcSexo tcSexo;
