...
public class VerificaUsuario implements Serializable{
    ...
    public GenericoDos catalogoUsuarioPorId(String idUsuario){
      ...
      perfilUsuario = (GenericoDos)  this.api.repuestaApi(perfilUsuario, "JSON", sql,"24.199.121.192");
    ...
    public GenericoDos buscaLicencia(String lic){
        ...
        licenciaGestionID = (GenericoDos)  this.api.repuestaApi(licenciaGestionID, "JSON", sql,"24.199.121.192");
