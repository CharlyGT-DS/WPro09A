...
@XmlRootElement(name = "tcMunicipio")
public class TcMunicipio {
    ...
    @XmlElementRefs({
        ...
        @XmlElementRef(name = "municipioDesc", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "municipioId", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "tcDepartamento", type = TcDepartamento.class, required = false)
    })
    @XmlMixed
