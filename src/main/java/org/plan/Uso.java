 ...
 *         &lt;element ref="{}tcUsoFinca"/&gt;
 *         &lt;element ref="{}usoFincaGestionId"/&gt;
 *       &lt;/choice&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class Uso {
    ...
    @XmlElementRefs({
        ...
        @XmlElementRef(name = "tcUsoFinca", type = TcUsoFinca.class, required = false),
        @XmlElementRef(name = "usoFincaGestionId", type = JAXBElement.class, required = false)
    })
    @XmlMixed
