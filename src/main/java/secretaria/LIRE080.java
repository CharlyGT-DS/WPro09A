...
public class LIRE080 implements Serializable{
    ...
    public void llamar(){
         try {
             ...
             this.contactos = this.mhome.getApi().convierteObjetoLista(sql, Dta.class);
    ...
    public void generarDocumento080(){ 
        try {
            ...
            List<java.util.LinkedHashMap> lis = (List<java.util.LinkedHashMap>) this.mhome.getApi().convierteObjetoLista(sql, java.util.LinkedHashMap.class);
