...
@Named (value = "secretariaAceptados")
@ViewScoped
public class SecretariaAceptados implements Serializable{
    ...
    public void trazlado(){
        ...
        try {
            ...
            Logger.getLogger(SecretariaAceptados.class.getName()).log(Level.SEVERE, null, ex);
