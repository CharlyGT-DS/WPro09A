...
public class CaracteristicasFinca implements Serializable {
    ...
    public void init() {
        ...
        List<java.util.LinkedHashMap> listaUsoF = (List<java.util.LinkedHashMap>) this.mhome.getApi().convierteObjetoLista(sqlUso, java.util.LinkedHashMap.class,"24.199.121.192");
        ...
        List<java.util.LinkedHashMap> listaTipoB = (List<java.util.LinkedHashMap>) this.mhome.getApi().convierteObjetoLista(sqlTipo, java.util.LinkedHashMap.class,"24.199.121.192");
        ...
        List<java.util.LinkedHashMap> listaCriterioP = (List<java.util.LinkedHashMap>) this.mhome.getApi().convierteObjetoLista(sqlCriterio, java.util.LinkedHashMap.class,"24.199.121.192");
