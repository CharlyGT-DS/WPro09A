...
public class PlanManejo implements Serializable {
    ...
    public void agregarNotificacion(){
     try{
        ...
        // api
        GEnericaCincoCampos tp = (GEnericaCincoCampos)  this.mhome.getApi().repuestaApi(new GEnericaCincoCampos(), "JSON", sql);       
    ...
    public void cargaCatalogos(int tipo, Persona per){
        ...
        List<java.util.LinkedHashMap> lis = (List<java.util.LinkedHashMap>) this.getMhome().getApi().convierteObjetoLista(sql, java.util.LinkedHashMap.class);
        ...
        List<java.util.LinkedHashMap> liDep = (List<java.util.LinkedHashMap>) this.mhome.getApi().convierteObjetoLista(sql,java.util.LinkedHashMap.class);
        ...
        List<java.util.LinkedHashMap> listaIdiomas = (List<java.util.LinkedHashMap>) this.mhome.getApi().convierteObjetoLista(sql,java.util.LinkedHashMap.class);
        ...
        List<java.util.LinkedHashMap> listaCultura = (List<java.util.LinkedHashMap>) this.mhome.getApi().convierteObjetoLista(sql, java.util.LinkedHashMap.class);
        ...
        List<java.util.LinkedHashMap> listaEstados = this.mhome.getApi().convierteObjetoLista(sql, java.util.LinkedHashMap.class);
        ...
        List<java.util.LinkedHashMap> lsex = (List<java.util.LinkedHashMap>) this.mhome.getApi().convierteObjetoLista(sql, java.util.LinkedHashMap.class);
