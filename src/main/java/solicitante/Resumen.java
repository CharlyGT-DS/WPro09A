...
public class Resumen implements Serializable {
    ...
    public void init() { 
        ...
        List<java.util.LinkedHashMap> listaTipoG = (List<java.util.LinkedHashMap>) this.mhome.getApi().convierteObjetoLista(sql, java.util.LinkedHashMap.class,"24.199.121.192");
        ...
        List<java.util.LinkedHashMap> listasSistemaC = (List<java.util.LinkedHashMap>) this.mhome.getApi().convierteObjetoLista(sqlS, java.util.LinkedHashMap.class,"24.199.121.192");
