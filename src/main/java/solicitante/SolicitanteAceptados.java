...
@Named (value = "solicitanteAceptados")
@ViewScoped
public class SolicitanteAceptados implements Serializable{
...
//           }
    ...
    public void trazlado(){
        ...
        try {
            ...
            System.out.println("id_usuario SOLICITANTE  (ORIGEN):"+this.mhome.getPer().getTcUsuario().getUsuarioId().toString());
            ...
            Logger.getLogger(SolicitanteAceptados.class.getName()).log(Level.SEVERE, null, ex);
