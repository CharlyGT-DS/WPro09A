...
@Named(value = "lire009")
@ViewScoped
public class LIRE009 implements Serializable {
    ...
    private List<LIRE009.Elemento> enmiendas = new ArrayList<>();
    ...
    public void agregarEnmienda() {
        activarBotonVistaPrevia();
        enmiendas.add(new LIRE009.Elemento(""));
    }

    public void eliminarEnmienda(LIRE009.Elemento elemento) {
        if (enmiendas.size() > 1) {
            enmiendas.remove(elemento);
        }
    }
